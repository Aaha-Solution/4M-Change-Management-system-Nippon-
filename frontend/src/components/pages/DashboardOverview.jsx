          ...
          <div className="bg-white border border-slate-200/60 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 space-y-[20px]">
            ...
            <div className="space-y-[4px]">
              ...
              <textarea
                ...
                placeholder="Describe the change — what, why, how, and expected outcome (min 20 characters)..."
                className="w-full bg-slate-50 border border-slate-200 rounded-[6px] py-[8px] px-[12px] text-[12px] outline-none focus:border-[#0066cc] focus:ring-4 focus:ring-[#0066cc]/10 transition-all duration-200 resize-none font-medium text-slate-700 h-[80px]"
              />
              <span className="block text-[10px] text-slate-400">
