...
CREATE TABLE l3_approvals (
    ...
    ped_remarks TEXT NULL,
    ped_approved_by VARCHAR(255) NULL,
    qad VARCHAR(50) NOT NULL DEFAULT 'Pending',
    qad_remarks TEXT NULL,
    qad_approved_by VARCHAR(255) NULL,
    production VARCHAR(50) NOT NULL DEFAULT 'Pending',
    production_remarks TEXT NULL,
    production_approved_by VARCHAR(255) NULL,
    maintenance VARCHAR(50) NOT NULL DEFAULT 'Pending',
    maintenance_remarks TEXT NULL,
    maintenance_approved_by VARCHAR(255) NULL,
    pcl VARCHAR(50) NOT NULL DEFAULT 'Pending',
    pcl_remarks TEXT NULL,
    pcl_approved_by VARCHAR(255) NULL,
    materials VARCHAR(50) NOT NULL DEFAULT 'Pending',
    materials_remarks TEXT NULL,
    materials_approved_by VARCHAR(255) NULL,
    marketing VARCHAR(50) NOT NULL DEFAULT 'Pending',
    marketing_remarks TEXT NULL,
    marketing_approved_by VARCHAR(255) NULL,
    hr VARCHAR(50) NOT NULL DEFAULT 'Pending',
    hr_remarks TEXT NULL,
    hr_approved_by VARCHAR(255) NULL,
    safety VARCHAR(50) NOT NULL DEFAULT 'Pending',
    safety_remarks TEXT NULL,
    safety_approved_by VARCHAR(255) NULL,
    unit_head VARCHAR(50) NOT NULL DEFAULT 'Pending',
    unit_head_remarks TEXT NULL,
    unit_head_approved_by VARCHAR(255) NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (change_no) REFERENCES change_requests(id) ON UPDATE CASCADE ON DELETE CASCADE
);
